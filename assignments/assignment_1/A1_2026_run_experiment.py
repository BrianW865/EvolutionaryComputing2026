...
POPULATION_SIZE = 20
EVALUATION_BUDGET = POPULATION_SIZE + 10 * NUM_OF_GENERATIONS
...
def main() -> None:
    for seed in SEEDS:
        ...
        evaluation_budget = max(run_EA1.num_evaluations, run_EA2.num_evaluations)

        run_random = random_search(seed, evaluation_budget, _)
